...
class ApiRepository {
  ...
  ///login api
  Future<LoginResponse> doLogin({String? type,String? username,String? password}) async {
  ...
  Future<ClaimTypeModel> getNatureOfClaimList() async {
    final response = await apiClient.post(
        ApiEndpoint.claimTypeListUrl, headers: headers
    );
  ...
  Future<ClientNameModel> getClientNameList() async {
    ...
    final response = await apiClient.post(
        ApiEndpoint.clientNameListUrl, body: formData, headers: headers,
    );
  ...
  Future<ClaimYearModel> getClaimYearList() async {
    ...
    final response = await apiClient.post(
        ApiEndpoint.claimYearListUrl, body: formData, headers: headers
    );
    return ClaimYearModel.fromJson(response);
  }
  ///claim service list
  Future<ClaimServiceResponse> getClaimServicesList(String selectedClientId,String selectedClaimYearId) async {
    final FormData formData = FormData.fromMap({
  ...
  Future<ClaimTaskResponse> getClaimTaskList(String serviceId) async {
    ...
    final response = await apiClient.post(
        ApiEndpoint.claimTaskListUrl,body:formData,headers: headers
    );
  ...
  Future<ClaimSubmittedByResponse> getClaimSubmittedByList() async {
    ...
    final response = await apiClient.post(
        ApiEndpoint.claimSubmittedByListUrl,body:formData,headers: headers
    );
    return ClaimSubmittedByResponse.fromJson(response);
  }
  ///add claim
  Future<Stream<String>> getAddClaimForm({String? taskName,String? claimDate,String? claimType,String? natureOfClaim,
    String? particulars, String? clientName,String? year,String? service,String? task,String? date,String? amount,
    String? claimSubmittedBy, String? claimImage,String? billable,String? travelFrom,String? travelTo,String? kms,
    String? challanNo, String? clientServiceId,String? billNo}) async {
  ...
  Future<ClaimEditResponse> getClaimEditList(String claimId) async {
    final FormData formData = FormData.fromMap({"claim_id":claimId,},);
    final response = await apiClient.post(
        ApiEndpoint.claimEditUrl,body:formData,headers: headers
    );
    return ClaimEditResponse.fromJson(response);
  }
  ///claim update
  Future<Stream<String>> getUpdateClaimForm({String? taskName,String? claimDate,String? claimType,String? natureOfClaim,
    String? particulars, String? clientName,String? year,String? service,String? task,String? date,String? amount,
    String? claimSubmittedBy, String? claimImage,String? billable,String? travelFrom,String? travelTo,String? kms,
    String? challanNo, String? clientServiceId,String? billNo,String? claimId}) async {
  ...
  ///claim status update
  Future<ApiResponse> getUpdateStatus(String claimId,String action,String remark) async {
    final FormData formData = FormData.fromMap({
      "mast_id":userId,"firm_id":firmId,"claim_id":claimId,"action":action,"remark":remark
    },);
    final response = await apiClient.post(
        ApiEndpoint.claimUpdateStatusUrl,body:formData,headers: headers
    );
    return ApiResponse.fromJson(response);
  }
  ///leave count
  Future<TotalLeaveCountResponse> getLeaveCountList() async {
    ...
    final response = await apiClient.post(
      ApiEndpoint.leaveCountUrl, body: formData, headers: headers,
    );
  ...
  Future<LeaveTypeModel> getLeaveTypeList() async {
    ...
    final response = await apiClient.post(
      ApiEndpoint.leaveTypeUrl, body: formData, headers: headers,
    );
  ...
  Future<LeaveEditModel> getLeaveEditList(String leaveId) async {
    ...
    final response = await apiClient.post(
        ApiEndpoint.leaveEditListUrl,body:formData,headers: headers
    );
    return LeaveEditModel.fromJson(response);
  }
  ///leave update
  Future<ApiResponse> getUpdateLeave(String leaveTypeId,String noOfDaysLeave,String startDate,String endDate,
      String reason,String leaveFor,String attempt,String group,String leaveId) async {
    final FormData formData = FormData.fromMap({
      "leaveType":leaveTypeId, "mast_id":userId,"firm_id":firmId,
      "ndays":noOfDaysLeave, "startdate":startDate, "enddate":endDate,
      "reason":reason, "leaveFor":leaveFor,"attempts":attempt, "group":group,
      "leave_id":leaveId
    },);
    final response = await apiClient.post(
      ApiEndpoint.leaveUpdateListUrl, body: formData, headers: headers,
    );
    return ApiResponse.fromJson(response);
  }
  ///leave update status
  Future<ApiResponse> getLeaveUpdateStatus(String leaveId,String action,String remark) async {
    final FormData formData = FormData.fromMap({
      "mast_id":userId,"firm_id":firmId,"leave_id":leaveId,"action":action,"remark":remark
    },);
    final response = await apiClient.post(
        ApiEndpoint.leaveUpdateStatusUrl,body:formData,headers: headers
    );
    return ApiResponse.fromJson(response);
  }
  ///timesheet action
  Future<ApiResponse> getTimesheetAction(String sid,String timesheetId,String action) async {
    final FormData formData = FormData.fromMap({
      "mast_id":userId,"firm_id":firmId,"sid":sid,"timesheet_id":timesheetId,"action":action
    },);
    final response = await apiClient.post(
      ApiEndpoint.timesheetActionUrl, body: formData, headers: headers,
    );
    return ApiResponse.fromJson(response);
  }
  ///Timesheet check
  ...
  ///timesheet add
  Future<ApiResponse> getTimesheetAdd(String date,String inTime,String outTime, String totalTime,String workAt) async {
    final FormData formData = FormData.fromMap({
  ...
  Future<CheckTimesheetTimeResponse> getTimesheetTotalTime(String date) async {
    final FormData formData = FormData.fromMap({
      "firm_id":firmId, "mast_id":userId,"timesheet_date":date,
    },);
    final response = await apiClient.post(
      ApiEndpoint.timesheetTotalTimeUrl, body: formData, headers: headers,
    );
  ...
  Future<TimesheetClientListModel> getTimesheetClientNameList() async {
    ...
    final response = await apiClient.post(
      ApiEndpoint.timesheetClientListUrl, body: formData, headers: headers,
    );
    return TimesheetClientListModel.fromJson(response);
  }
  ///timesheet services
  Future<TimesheetServiceListModel> getTimesheetServicesList(String clientId) async {
    final FormData formData = FormData.fromMap({
  ...
  Future<TimesheetServiceListModel> getTimesheetNonAllottedServicesList(String clientId) async {
    ...
    final response = await apiClient.post(
      ApiEndpoint.timesheetGetNonAllottedServicesUrl, body: formData, headers: headers,
    );
    return TimesheetServiceListModel.fromJson(response);
  }
  ///timesheet task
  Future<TimesheetTaskModel> getTimesheetTaskList(String serviceId,String clientApplicableServiceId) async {
    final FormData formData = FormData.fromMap({
  ...
  Future<ApiResponse> getTimesheetStatusUpdate(String clientServiceId,String taskId,String remark,String sid) async {
    final FormData formData = FormData.fromMap({
      "firm_id":firmId,"mast_id":userId,"client_applicable_service_id":clientServiceId,"task_id":taskId,
      "remark":remark,"sid":sid
    },);
    final response = await apiClient.post(
      ApiEndpoint.timesheetStatusUpdateUrl, body: formData, headers: headers,
    );
    return ApiResponse.fromJson(response);
  }
  ///timesheet start
  Future<ApiResponse> getTimesheetStart(String clientServiceId,String taskId) async {
    final FormData formData = FormData.fromMap({
      "firm_id":firmId,"mast_id":userId,"client_applicable_service_id":clientServiceId,"task_id":taskId,
    },);
    final response = await apiClient.post(
      ApiEndpoint.timesheetStartStatusUrl, body: formData, headers: headers,
    );
    return ApiResponse.fromJson(response);
  }
  ///timesheet add allotted
  Future<ApiResponse> getTimesheetAddAllotted(String date,String clientId,String serviceId,
      String clientApplicableServiceId, String taskId,String remark,String noOfHours) async {
    final FormData formData = FormData.fromMap({
      "firm_id":firmId, "mast_id":userId,"timesheet_date":date,"client_id":clientId,
  ...
  Future<ApiResponse> getTimesheetAddNonAllotted(String date,String clientId,String serviceId, String clientApplicableServiceId, String taskId,String remark,String noOfHours) async {
    final FormData formData = FormData.fromMap({
      "firm_id":firmId, "mast_id":userId,"timesheet_date":date,"client_id":clientId,
      "service_id":serviceId,"client_applicable_service_id":clientApplicableServiceId,
      "task_id":taskId, "remark":remark, "nohours":noOfHours,
    ...
    final response = await apiClient.post(
      ApiEndpoint.timesheetAddNonAllottedUrl, body: formData, headers: headers,
    );
    return ApiResponse.fromJson(response);
  }
  ///timesheet type of work
  Future<TypeOfWorkModel> getTimesheetTypeOfWork() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,},);
    final response = await apiClient.post(
      ApiEndpoint.timesheetTypeOfWorkUrl, body: formData, headers: headers,
    );
    return TypeOfWorkModel.fromJson(response);
  }
  ///timesheet add office related
  Future<ApiResponse> getTimesheetAddOfficeRelated(String date,String typeWorkId,
      String remark,String noOfHours,String action) async {
    final FormData formData = FormData.fromMap({
      "firm_id":firmId, "mast_id":userId,"timesheet_date":date,"type_work":typeWorkId,
       "remark":remark, "nohours":noOfHours,"action":action
    },);
    final response = await apiClient.post(
      ApiEndpoint.timesheetAddOfficeRelatedUrl, body: formData, headers: headers,
    );
    return ApiResponse.fromJson(response);
  }
  ///timesheet list
  Future<TimesheetListModel> getTimesheetList(String action,String flag) async {
    final FormData formData = FormData.fromMap({
      "firm_id":firmId, "mast_id":userId,"status":action,"flag":flag
    },);
    final response = await apiClient.post(
      ApiEndpoint.timesheetListUrl, body: formData, headers: headers,
    );
  ...
  Future<TimesheetEditData> getTimesheetEdit(String date,String empId) async {
    final FormData formData = FormData.fromMap({
      "firm_id":firmId, "mast_id":userId,"timesheet_date":date,"emp_id":empId,
    },);
    final response = await apiClient.post(
      ApiEndpoint.timesheetEditUrl, body: formData, headers: headers,
    );
  ...
  Future<TimesheetLogModel> getTimesheetLog(String date,String id) async {
    final FormData formData = FormData.fromMap({
      "firm_id":firmId, "mast_id":userId,"timesheet_date":date,"id":id,
    },);
    final response = await apiClient.post(
      ApiEndpoint.timesheetLogUrl, body: formData, headers: headers,
    );
  ...
  Future<BranchNameModel> getBranchNameList() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,},);
    final response = await apiClient.post(
      ApiEndpoint.branchNameListUrl, body: formData, headers: headers,
    );
    return BranchNameModel.fromJson(response);
  }
  ///branch client list
  Future<BranchClientListModel> getBranchClientList(String branchId) async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"branch_id":branchId},);
    final response = await apiClient.post(
      ApiEndpoint.branchClientListUrl, body: formData, headers: headers,
    );
    return BranchClientListModel.fromJson(response);
  }
  ///branch emp list
  Future<BranchEmpModel> getBranchEmpList(String branchId) async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"branch_id":branchId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.branchEmpListUrl, body: formData, headers: headers,
    );
  ...
  Future<OwnChartModel> getOwnPieChart() async {
    ...
    final response = await apiClient.post(
      ApiEndpoint.ownPieChartUrl, body: formData, headers: headers,
    );
  ...
  Future<TriggerNotAllottedModel> getServiceTriggerNotAllottedPieChart() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.serviceTriggerButNotAllottedUrl, body: formData, headers: headers,
    );
  ...
  Future<AllottedNotStartedModel> getAllottedNotStartedPieChart() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.allottedNotStartedUrl, body: formData, headers: headers,
    );
  ...
  Future<StartedNotCompletedModel> getStartedNotCompletedPieChart() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.startedNotCompletedUrl, body: formData, headers: headers,
    );
  ...
  Future<CompletedUdinPendingModel> getCompletedUDINPendingPieChart() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.completedUDINPendingUrl, body: formData, headers: headers,
    );
  ...
  Future<CompletedNotBilledModel> getCompletedNotBilledPieChart() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.completedNotBilledUrl, body: formData, headers: headers,
    );
  ...
  Future<WorkOnHoldModel> getWorkOnHoldPieChart() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.workOnHoldUrl, body: formData, headers: headers,
    );
  ...
  Future<SubmittedForCheckingModel> getSubmittedForCheckingPieChart() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.submittedForCheckingUrl, body: formData, headers: headers,
    );
  ...
  Future<AllTaskCompletedModel> getAllTaskCompletedPieChart() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.allTaskCompletedUrl, body: formData, headers: headers,
    );
    return AllTaskCompletedModel.fromJson(response);
  }
  ///calender
  Future<CalenderModel> getCalender(String year) async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId,"year":year},);
    final response = await apiClient.post(
      ApiEndpoint.calenderUrl, body: formData, headers: headers,
    );
    return CalenderModel.fromJson(response);
  }
  ///calender due date
  Future<CalendarDueDateModel> getCalenderDueDate(String date,String type) async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId,"date":date,"type":type},);
    final response = await apiClient.post(
      ApiEndpoint.calenderDueDateUrl, body: formData, headers: headers,
    );
    return CalendarDueDateModel.fromJson(response);
  }
  ///allotted not started past due team
  Future<AllottedNotStartedPastDueTeam> getAllottedNotStartedPastDueTeam() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.allottedNotStartedPastDueTeamUrl, body: formData, headers: headers,
    );
    return AllottedNotStartedPastDueTeam.fromJson(response);
  }
  ///allotted not started past due own
  Future<AllottedNotStartedPastDueTeam> getAllottedNotStartedPastDueOwn() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.allottedNotStartedPastDueOwnUrl, body: formData, headers: headers,
    );
    return AllottedNotStartedPastDueTeam.fromJson(response);
  }

  ///allotted not started probable overdue team
  Future<AllottedNotStartedPastDueTeam> getAllottedNotStartedProbableTeam() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.allottedNotStartedProbableOverdueTeamUrl, body: formData, headers: headers,
    );
    return AllottedNotStartedPastDueTeam.fromJson(response);
  }
  ///allotted not started probable overdue own
  Future<AllottedNotStartedPastDueTeam> getAllottedNotStartedProbableOwn() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.allottedNotStartedProbableOverdueOwnUrl, body: formData, headers: headers,
    );
    return AllottedNotStartedPastDueTeam.fromJson(response);
  }
  ...
  Future<AllottedNotStartedPastDueTeam> getAllottedNotStartedHighTeam() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.allottedNotStartedHighTeamUrl, body: formData, headers: headers,
    );
    return AllottedNotStartedPastDueTeam.fromJson(response);
  }
  ...
  Future<AllottedNotStartedPastDueTeam> getAllottedNotStartedHighOwn() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.allottedNotStartedHighOwnUrl, body: formData, headers: headers,
    );
    return AllottedNotStartedPastDueTeam.fromJson(response);
  }

  ///allotted not started medium team
  Future<AllottedNotStartedPastDueTeam> getAllottedNotStartedMediumTeam() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.allottedNotStartedMediumTeamUrl, body: formData, headers: headers,
    );
    return AllottedNotStartedPastDueTeam.fromJson(response);
  }
  ...
  Future<AllottedNotStartedPastDueTeam> getAllottedNotStartedMediumOwn() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.allottedNotStartedMediumOwnUrl, body: formData, headers: headers,
    );
    return AllottedNotStartedPastDueTeam.fromJson(response);
  }
  ...
  Future<AllottedNotStartedPastDueTeam> getAllottedNotStartedLowTeam() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.allottedNotStartedLowTeamUrl, body: formData, headers: headers,
    );
    return AllottedNotStartedPastDueTeam.fromJson(response);
  }
  ...
  Future<AllottedNotStartedPastDueTeam> getAllottedNotStartedLowOwn() async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId},);
    final response = await apiClient.post(
      ApiEndpoint.allottedNotStartedLowOwnUrl, body: formData, headers: headers,
    );
    return AllottedNotStartedPastDueTeam.fromJson(response);
  }
  ...
  Future<ApiResponse> getStartService(String id) async {
    ...
    final response = await apiClient.post(
      ApiEndpoint.startServiceUrl, body: formData, headers: headers,
    );
    return ApiResponse.fromJson(response);
  }
  ...
  Future<ApiResponse> getCheckPassword(String pass) async {
    final FormData formData = FormData.fromMap({"firm_id":firmId,"mast_id":userId,"password":pass},);
    final response = await apiClient.post(
      ApiEndpoint.checkPasswordUrl, body: formData, headers: headers,
    );
    return ApiResponse.fromJson(response);
  }
  ///cancel service
