      ...
      return WillPopScope(
          ...
          child: Scaffold(
              ...
              appBar: AppBar(
                ...
                title: buildTextMediumWidget("Manual Assignment", whiteColor,context, 16,align: TextAlign.center),
              ),
              drawer: Drawer(
                child: SizedBox(
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      GestureDetector(
                                        onTap: (){
                                          showWarningOnManualAssignmentDialog(context,"Confirm Logout...!!!","Do you want to logout from an app?",logoutFeature:true,cont);
                                        },
                ...
                child:ListView(
                  ...
                  children:[
                        ...
                        child: Center(
                            child: Padding(
                              ...
                              child: DropdownButton<String>(
                                hint: buildTextRegularWidget(cont.selectedYear==""?"F.Y.":cont.selectedYear,
                    ...
                    Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: const BorderRadius.all(Radius.circular(5)),
                          border: Border.all(color: cont.validateMainCategory?errorColor:grey),),
                        child: Center(
                            child: Padding(
                              padding: const EdgeInsets.only(left: 15.0,right: 15.0),
                              child:
                              DropdownButton<String>(
                                hint: buildTextRegularWidget(cont.selectedMainCategory==""?"Category":cont.selectedMainCategory,
                                    blackColor, context, 15.0,align: TextAlign.left),
                                isExpanded: true,
                                underline: Container(),
                                items:
                                cont.mainCategoryList.isEmpty
                                    ? cont.noDataList.map((value) {
                                  return DropdownMenuItem<String>(
                                    value: value,
                                    child: Text(value),
                                    ...
                                    :
                                cont.mainCategoryList.map((ServicesMainCategoryList value) {
                                  return DropdownMenuItem<String>(
                                    value: value.serviceMainCategoryName,
                                    child: Text(value.serviceMainCategoryName!),
                                    onTap: (){
                                      cont.updateSelectedMainCategoryId(value.serviceMainCategoryId!);
                                    },
                                  );
                                }).toList(),
                                onChanged: (val) {
                    ...
                    Container(
                        ...
                        child: Center(
                            child: Padding(
                              ...
                              child:
                              DropdownButton<String>(
                                hint: buildTextRegularWidget(cont.selectedService==""?"Service":cont.selectedService,
                                    blackColor, context, 15.0,align: TextAlign.left),
                                isExpanded: true,
                                underline: Container(),
                                items:
                    ...
                    Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: const BorderRadius.all(Radius.circular(5)),
                          border: Border.all(color: cont.validatePriority?errorColor:grey),),
                        child: Center(
                            child: Padding(
                              padding: const EdgeInsets.only(left: 15.0,right: 15.0),
                              child:
                              DropdownButton<String>(
                                hint: buildTextRegularWidget(cont.selectedPriority==""?"Select Priority":cont.selectedPriority, blackColor, context, 15.0),
                                isExpanded: true,
                                underline: Container(),
                                items:
                                cont.priorityList.isEmpty
                                    ? cont.noDataList.map((value) {
                                  return DropdownMenuItem<String>(
                                    value: value,
                                    child: Text(value),
                                ...
                                cont.priorityList.map((value) {
                                  return DropdownMenuItem<String>(
                                    ...
                                    child: Text(value),
                                    onTap: (){
                                      cont.updateSelectedPriority(value,context);
                                    },
                                  );
                                }).toList(),
                                onChanged: (val) {
                              ...
                              child: DropdownButton(
                                ...
                                cont.employeeList.isEmpty
                                  ...
                                  return DropdownMenuItem<String>(
                                    ...
                                    onTap: (){
                                      cont.updateSelectedEmployee(value.firmEmployeeName!,value.mastId!);
                                    },
                                  );
                                }).toList(),
                                onChanged: (val) {
                    ...
                    cont.validateFees == true
                        ...
                        : const Opacity(opacity: 0.0),
                    ///remark
                    buildTimeSheetTitle(context,"Remark (This will be appended to service name for reference)"),
                    Container(
                      height: 40.0,
                      decoration: BoxDecoration(
                        borderRadius: const BorderRadius.all(Radius.circular(5)),
