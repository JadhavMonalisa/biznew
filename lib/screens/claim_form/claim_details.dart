          ...
          child: Scaffold(
              appBar: AppBar(
                ...
                title: buildTextMediumWidget(
                    "Claim Details", whiteColor, context, 16,
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        buildRichTextWidget("Service name - ",
                                            item.serviceName!),
                                        const SizedBox(
                                          height: 10.0,
                                        ),
                                        ...
                                        buildRichTextWidget("Employee name - ",
                                            item.firmEmployeeName!),
                                        const SizedBox(
                                          height: 10.0,
                                        ),
                                        buildRichTextWidget("Year - ",
                                        ...
                                        buildTextBoldWidget("Particulars",
                                        ...
                                        buildTextBoldWidget("Claim file",
                                            blackColor, context, 14.0),
                                        const SizedBox(
                                          height: 10.0,
                                        ),
