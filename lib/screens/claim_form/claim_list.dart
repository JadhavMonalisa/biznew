...
class _ClaimListState extends State<ClaimList> {
    ...
    return GetBuilder<ClaimFormController>(builder: (cont) {
      return WillPopScope(
          ...
          child: Scaffold(
              appBar: AppBar(
                centerTitle: true,
                title: buildTextMediumWidget("Claims", whiteColor, context, 16,
                        ...
                        child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  buildTextBoldWidget(
                                      "Export", whiteColor, context, 15.0),
                                  const Icon(
                                    Icons.import_export,
                                    color: whiteColor,
                                    size: 25.0,
                        ...
                        child: ListView(
                          ...
                          children: [
                            Padding(
                                ...
                                child: Row(
                                  children: [
                                    buildTextRegularWidget("Select View Claim ",
                                    ...
                                    child: Container(
                                        ...
                                        child: Center(
                                          ...
                                          child: DropdownButton(
                                            ...
                                            isExpanded: true,
                                            underline: Container(),
                                            items: cont.claimSubmittedByList
                                                    .isEmpty
                            ...
                            Padding(
                              ...
                              child: Container(
                                  ...
                                  child: Center(
                                    ...
                                    child: DropdownButton(
                                      hint: buildTextRegularWidget(
                                          cont.selectedClaimStatus == "None"
                                              ? "Select claim status"
                                              : cont.selectedClaimStatus,
                                          blackColor,
                                          context,
                                          15.0),
                                      isExpanded: true,
                                      underline: Container(),
                                      items: cont.claimStatusList
                                          .map((String claimStatus) {
                                ...
                                : ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return Padding(
                                          ...
                                          child: buildNewClaimList(
                                              cont.claimClientList[index],
                                              cont));
                                    })
                          ],
                        ),
  ...
  Widget buildNewClaimList(
      ClaimClientListDetails item, ClaimFormController cont) {
    return Card(
      color: faintGrey,
          ...
          children: <Widget>[
              ...
              children: [
                Flexible(
                  child: Container(
                    ...
                    title2Color: item.claimStatus == "Pending" ||
                            item.claimStatus == "Pending for approval"
                        ? Colors.orange
                        : item.claimStatus == "Rejected" ||
                                item.claimStatus == "Deleted"
                            ? Colors.red
                ...
                Container(
                  ...
                  child: Center(
                      child: buildTextRegularWidget(
                          "${Strings.rupees} ${item.claimAmount!}",
                          whiteColor,
                          context,
                          14.0)),
                ),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  cont.reportingHead == "0" && item.claimStatus == "Approved"
                      ? const Opacity(
                          opacity: 0.0,
                        )
                      : Flexible(
                                            ...
                                            Row(
                                              children: [
                                                Flexible(
                                                    child: GestureDetector(
                                                  onTap: () {
                                                    cont.updateStatus("Reject",
                                                        item.claimId!, context);
                                                  },
  ...
  Widget buildClaimList(ClaimClientListDetails item, ClaimFormController cont) {
    return Card(
      ...
      child: ExpansionTile(
        title: item.office == "0"
            ? buildTextRegularWidget(
                "${item.firmEmployeeName!} submitted claim of Rs. ${item.claimAmount!} against ${item.firmClientFirmName!} on ${item.claimDate!}.",
                blackColor,
                context,
                14.0,
                align: TextAlign.left)
            : buildTextRegularWidget(
                "${item.firmEmployeeName!} submitted claim of Rs. ${item.claimAmount!} on ${item.claimDate!}.",
                blackColor,
                context,
                14.0,
                align: TextAlign.left),
        ...
        children: <Widget>[
          Table(
            children: [
              ...
              buildContentSubTitle(context,
                  contentTitle1: item.billDate!,
                  contentTitle2: item.cliamBillable!,
                  contentTitle3: item.claimStatus!,
                  fontSize: 14.0),
          ...
          Table(
            children: [
              ...
              TableRow(children: [
                buildTextBoldWidget(
                    item.particulars!, blackColor, context, 14.0),
              ]),
            ],
          ),
          const SizedBox(
