...
class YearList {
  ...
  YearList.fromJson(Map<String, dynamic> json) {
    finanacialYearStartDate = json['finanacial_year_start_date']=="" || json['finanacial_year_start_date']==null
        ? "" : json['finanacial_year_start_date'].toString().replaceAll("-", "/");
    finanacialYearEndDate = json['finanacial_year_end_date']=="" || json['finanacial_year_end_date']==null
...
class ClaimSubmittedByResponse {
  ...
  ClaimSubmittedByResponse({this.message, this.success, this.claimSubmittedByListDetails});
  ...
  Map<String, dynamic> toJson() {
    ...
    if (claimSubmittedByListDetails != null) {
      data['emplyeeList'] = claimSubmittedByListDetails!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class ClaimSubmittedByList {
  ...
  ClaimSubmittedByList({this.firmEmployeeName, this.mastId, this.firmEmployeeId, this.roleId});
...
class ClaimClientListResponse {
  ...
  ClaimClientListResponse({this.message, this.success, this.claimClientListDetails});
  ...
  Map<String, dynamic> toJson() {
    ...
    if (claimClientListDetails != null) {
      data['ClaimList'] = claimClientListDetails!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class ClaimClientListDetails {
  ...
  ClaimClientListDetails({this.claimId, this.clientName, this.service, this.task, this.typeOfClaim,
        this.particulars, this.claimFrom, this.claimTo, this.kms, this.billNo, this.billDate,
        this.challan, this.file, this.claimAmount, this.cliamBillable, this.includedBill,
        this.claimDate, this.claimStatus, this.mastId, this.firmId, this.addOnDate, this.addedBy,
        this.modifiedOnDate, this.modifiedBy, this.timesheet, this.office, this.cliamFinancialYearId,
        this.mytask, this.clientApplicableService, this.firmClientClientCode, this.firmClientFirmName,
        this.firmClientStatus, this.tradeName, this.taskName, this.serviceName, this.name, this.firmEmployeeName});
...
class ClaimEditResponse {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (claimDetails != null) {
      data['Claim Details'] =
          claimDetails!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
class ClaimDetails {
  ...
  ClaimDetails.fromJson(Map<String, dynamic> json) {
    claimId = json['claim_id']==null || json['claim_id']=="" ? "" : json['claim_id'];
    clientName = json['client_name']==null || json['client_name']=="" ? "" :json['client_name'];
    service = json['service']==null || json['service']=="" ? "" :json['service']??"";
    task = json['task']==null || json['task']=="" ? "" :json['task']??"";
    typeOfClaim = json['type_of_claim']==null || json['type_of_claim']=="" ? "" :json['type_of_claim']??"";
    particulars = json['particulars']==null || json['particulars']=="" ? "" :json['particulars']??"";
    claimFrom = json['claim_from']==null || json['claim_from']=="" ? "" :json['claim_from']??"";
    claimTo = json['claim_to']==null || json['claim_to']=="" ? "" :json['claim_to']??"";
    kms = json['kms']==null || json['kms']=="" ? "" :json['kms']??"";
    billNo = json['bill_no']==null || json['bill_no']=="" ? "" :json['bill_no']??"";
    billDateToSend = json['bill_date']==null || json['bill_date']=="" ? "" :json['bill_date']??"";
    billDate =  json['bill_date'] ==null || json['bill_date'] == "" ? "" :
        DateFormat("dd-MM-yyyy").format(DateTime.parse(json["bill_date"]));
    challan = json['challan']==null || json['challan']=="" ? "" :json['challan']??"";
    file = json['file']==null || json['file']=="" ? "" :json['file']??"";
    claimAmount = json['claim_amount']==null || json['claim_amount']=="" ? "" :json['claim_amount']??"";
    cliamBillable = json['cliam_billable']==null || json['cliam_billable']=="" ? "" :json['cliam_billable']??"";
    includedBill = json['included_bill']==null || json['included_bill']=="" ? "" :json['included_bill']??"";
    claimDateToSend = json['claim_date']==null || json['claim_date']=="" ? "" :json['claim_date']??"";
    claimDate = json['claim_date'] ==null || json['claim_date'] == "" ? "" :
    DateFormat("dd-MM-yyyy").format(DateTime.parse(json["claim_date"]));
    claimStatus = json['claim_status']==null || json['claim_status']=="" ? "" :json['claim_status']??"";
    mastId = json['mast_id']==null || json['mast_id']=="" ? "" :json['mast_id']??"";
    firmId = json['firm_id']==null || json['firm_id']=="" ? "" :json['firm_id']??"";
    addOnDate = json['add_on_date']==null || json['add_on_date']=="" ? "" :json['add_on_date']??"";
    addedBy = json['added_by']==null || json['added_by']=="" ? "" :json['added_by']??"";
    modifiedOnDate = json['modified_on_date']==null || json['modified_on_date']=="" ? "" :json['modified_on_date']??"";
    modifiedBy = json['modified_by']==null || json['modified_by']=="" ? "" :json['modified_by']??"";
    timesheet = json['timesheet']==null || json['timesheet']=="" ? "" :json['timesheet']??"";
    office = json['office']==null || json['office']=="" ? "" :json['office']??"";
    cliamFinancialYearId = json['cliam_financial_year_id']==null || json['cliam_financial_year_id']=="" ? "" :json['cliam_financial_year_id']??"";
    mytask = json['mytask']==null || json['mytask']=="" ? "" :json['mytask']??"";
    clientApplicableService =json['client_applicable_service']==null || json['client_applicable_service']=="" ? "" : json['client_applicable_service']??"";
    serviceName = json['service_name']==null || json['service_name']=="" ? "" :json['service_name']??"";
    name = json['name']==null || json['name']=="" ? "" :json['name']??"";
    firmEmployeeName =json['firm_employee_name']==null || json['firm_employee_name']=="" ? "" : json['firm_employee_name']??"";
    firmClientName = json['firm_client_firm_name']==null || json['firm_client_firm_name']=="" ? "" :json['firm_client_firm_name']??"";
    startYear =json['YEAR(y.finanacial_year_start_date)']==null || json['YEAR(y.finanacial_year_start_date)']=="" ? "" : json['YEAR(y.finanacial_year_start_date)']??"";
    endYear = json['YEAR(y.finanacial_year_end_date)']==null || json['YEAR(y.finanacial_year_end_date)']=="" ? "" :json['YEAR(y.finanacial_year_end_date)']??"";
    taskName = json['task_name']==null || json['task_name']=="" ? "" :json['task_name']??"";
  }
