...
class _ExportScreenState extends State<ExportScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: buildTextMediumWidget("Export claim", whiteColor,context, 16,align: TextAlign.center),
...
class ClaimDataSource extends DataGridSource {
  ClaimDataSource({required List<ClaimClientListDetails> claimData}) {
    _claimData = claimData.map<DataGridRow>((ClaimClientListDetails e) => DataGridRow(
        cells:
    <DataGridCell>[
      DataGridCell<String>(columnName: 'ID', value: e.claimId,),
      DataGridCell<String>(columnName: 'Name', value: e.name,),
      DataGridCell<String>(columnName: 'Claim Date', value: e.claimDate),
      DataGridCell<String>(columnName: 'Amount', value: e.claimAmount),
      DataGridCell<String>(columnName: 'Bill Date', value: e.billDate),
      DataGridCell<String>(columnName: 'Billable', value: e.cliamBillable),
      DataGridCell<String>(columnName: 'Task Name', value: e.taskName),
      DataGridCell<String>(columnName: 'Service Name', value: e.serviceName),
      DataGridCell<String>(columnName: 'Status', value: e.claimStatus,),
      DataGridCell<String>(columnName: 'Particulars', value: e.particulars,),
    ])).toList();
  }
