      ...
      return WillPopScope(
          ...
          child:Scaffold(
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      GestureDetector(
                                        onTap: (){
                                          showClientDashboardDialog(context,"Confirm Logout...!!!","Do you want to logout from an app?",logoutFeature:true,cont);
                                        },
              ...
              body: SizedBox(
                  ...
                  cont.clientDashboardListData.isEmpty ? buildNoDataFound(context):
                  Padding(
                    padding: const EdgeInsets.only(top: 10.0,bottom: 10.0),
                    child: ListView.builder(
                        shrinkWrap: true,
                        itemCount: cont.clientDashboardListData.length,
                        itemBuilder: (context,index){
                          final item = cont.clientDashboardListData[index];
                          return
                            item.totalCnt == "0" && item.billedCnt == "0"  && item.unbilledCnt == "0"
                            && item.docsInHand == "0"
                                ...
                                child: ListTileTheme(
                                  ...
                                  child: ExpansionTile(
                                            ...
                                            Container(
                                                ...
                                                child: Align(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: buildTextBoldWidget(item.client_code!, whiteColor, context, 14.0),
                                                    )
                                                )
                                            ),
                                            Flexible(
                                    ...
                                    children: [
                                      Transform(
                                        transform: Matrix4.translationValues(0.0, -7.0, 0.0),
                                        child: const Divider(color: primaryColor,),),
                                      Transform(
                                        ...
                                        child: Table(
                                          ...
                                          children: [
                                            ...
                                            TableRow(
                                                children: [
                                                  buildTextBoldWidget(item.triggeredCnt!, blackColor, context, 14.0,align: TextAlign.center),
