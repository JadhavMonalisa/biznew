      ...
      return WillPopScope(
          ...
          child:Scaffold(
              appBar: AppBar(
                ...
                title: buildTextMediumWidget("Allotted but not started (Bulk)", whiteColor,context, 16,align: TextAlign.center),
              ),
                  ...
                  child: ListView(
                    children: [
                      Padding(
                        ...
                        child: buildTextBoldWidget("Select services to cancel", blackColor, context, 16.0),
                      ),
                      SizedBox(
                        height: MediaQuery.of(context).size.height,
                        width: MediaQuery.of(context).size.width,
                                ...
                                child: Card(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                          ...
                                          text: TextSpan(
                                            ...
                                            children: <TextSpan>[
                                              TextSpan(
                                                  ...
                                                  recognizer: TapGestureRecognizer()..onTap = () {
                                                    cont.selectTargetDateForAll(context,item.id!);
                                                  }
                                              ),
                                            ],
                                          ),
                                      ...
                                      Row(
                                        children: <Widget>[
                                          buildTextRegularWidget("Select this service to cancel", blackColor, context, 14.0),
                                          Checkbox(
                                              value: cont.addedId.contains(item.id) ? true : false,
                                              onChanged: (onChanged){
                                               cont.onCheckBoxSelect(context,item.id!);
                                              }),
                                        ],
                                      ),
                                      Padding(
                                                        ...
                                                        child: DropdownButton(
                                                          hint: buildTextRegularWidget(
                                                              cont.addedPriorityListForAll.contains(item.id)
                                                                ? cont.selectedAllPriority==""?item.priorityToShow!:cont.selectedAllPriority
                                                                : item.priorityToShow!,
                                                          ...
                                                          onChanged: (val) {
                                                            cont.updatePriorityForAll(val!,item.id!);
                                                          },
                                                        ),
                                                      )
                                                  )
                ...
                child: GestureDetector(
                  onTap: (){
                   // cont.showCheckPasswordOrReasonDialog("Reason for cancel",context);
                    cont.showCheckPasswordOrReasonDialog("Cancel selected services",context);
                  },
                  child: buildButtonWidget(context, "Cancel selected services",height: 50.0,buttonColor: errorColor,buttonFontSize:14.0),
                )  ),
          )
      );
    });
