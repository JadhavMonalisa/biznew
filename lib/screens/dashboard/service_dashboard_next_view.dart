                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    RichText(
                                      ...
                                      text: TextSpan(
                                        text:  cont.selectedMainType == "StartedNotCompleted"?"Name of the staff - ":"Assigned to - ",
                                        style: const TextStyle(fontWeight: FontWeight.bold,color: blackColor,fontSize: 16,),
                                        children: <TextSpan>[
                                          ...
                                          const TextSpan(
                                              text: "   Total : ",
                                              style: TextStyle(fontWeight: FontWeight.bold,color: blackColor,fontSize: 16,)),
                                          TextSpan(
                                              text: item.days!,
                                              style: const TextStyle(fontWeight: FontWeight.normal,color: blackColor,fontSize: 16,),),
                                          const TextSpan(
                                            text: "D ",
                                            style: TextStyle(fontWeight: FontWeight.bold,color: blackColor,fontSize: 16),),
                                          TextSpan(
                                    ...
                                    item.taskEmp == cont.userId
                                      ...
                                      children: [
                                        Flexible(child: buildTextBoldWidget("Status - ", blackColor, context, 14.0),),
                                        Flexible(child: buildTextRegularWidget("Started", blackColor, context, 14.0)),
                                      ],
                                    )
