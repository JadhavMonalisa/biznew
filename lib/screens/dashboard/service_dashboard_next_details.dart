...
class ServiceDashboardNextDetails extends StatefulWidget {
  ...
  @override
  State<ServiceDashboardNextDetails> createState() =>
      _ServiceDashboardNextDetailsState();
}

class _ServiceDashboardNextDetailsState
    extends State<ServiceDashboardNextDetails> {
  @override
                                                  ...
                                                  children: [
                                                    Flexible(
                                                      child: GestureDetector(
                                                        onTap: () {
                                                          cont.removeFromSelectedAllotted(
                                                            index,
                                                          );
                                                        },
                                                        child:
                                                    ...
                                                    Flexible(
                                                      child: GestureDetector(
                                                        onTap: () {
                                                          cont.checkAllAddedValuesForAllotted(
                                                              index);
                                                        },
                                                        child:
                                                            buildButtonWidget(
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              buildTextRegularWidget(
                                  cont.allottedTotalCompletion.toString(),
                                  blackColor,
                                  context,
                                  15.0),
                              const Spacer(),
                              ...
                              buildTextRegularWidget(
                                  cont.allottedTotalDays.toString(),
                                  blackColor,
                                  context,
                                  15.0),
                              buildTextBoldWidget(
                              ...
                              buildTextRegularWidget(
                                  cont.allottedTotalHours.toString(),
                                  blackColor,
                                  context,
                                  15.0),
                              buildTextBoldWidget(
                              ...
                              buildTextRegularWidget(
                                  cont.allottedTotalMins.toString(),
                                  blackColor,
                                  context,
                                  15.0),
                              buildTextBoldWidget(
