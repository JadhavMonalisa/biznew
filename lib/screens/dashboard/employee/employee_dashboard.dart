          ...
          child: Scaffold(
              ...
              appBar: AppBar(
                ...
                title: buildTextMediumWidget(
                    "Employee Dashboard", whiteColor, context, 16,
              ...
              body: SizedBox(
                  ...
                  child: cont.loader == true
                      ...
                      : cont.employeeDashboardListData.isEmpty
                          ...
                          : Padding(
                              ...
                              child: ListView.builder(
                                  shrinkWrap: true,
                                  itemCount:
                                      cont.employeeDashboardListData.length,
                                  itemBuilder: (context, index) {
                                    final item =
                                        cont.employeeDashboardListData[index];
                                    return Padding(
                                        padding: const EdgeInsets.only(
                                            left: 5.0, right: 5.0),
                                        child: Card(
                                                          ...
                                                          child: Align(
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: buildTextBoldWidget(
                                                                    "${Strings.rupees} ${item.pendingClaims!}",
                                                                    whiteColor,
                                                                    context,
                                                                    14.0),
                                                              ))),
