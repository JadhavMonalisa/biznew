...
class StartedNotCompletedTaskViewScreen extends StatefulWidget {
  ...
  @override
  State<StartedNotCompletedTaskViewScreen> createState() =>
      _StartedNotCompletedTaskViewScreenState();
}

class _StartedNotCompletedTaskViewScreenState
    extends State<StartedNotCompletedTaskViewScreen> {
  @override
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            buildTextBoldWidget(" Total : ",
                                                blackColor, context, 14.0),
                                            buildTextRegularWidget(item.days!,
                                                blackColor, context, 14.0),
                                            buildTextBoldWidget("D ",
                                                blackColor, context, 14.0),
                                            buildTextRegularWidget(item.hours!,
                                                blackColor, context, 14.0),
                                            buildTextBoldWidget("H ",
                                                blackColor, context, 14.0),
                                            buildTextRegularWidget(item.mins!,
                                                blackColor, context, 14.0),
                                            buildTextBoldWidget(
                                                                      ...
                                                                      child: Container(
                                                                          ...
                                                                          child: Center(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              isExpanded: true,
                                                                              underline: Container(),
                                                                              items: cont.rh1taskStatusList.map((String value) {
                                                                      ...
                                                                      child: Container(
                                                                          ...
                                                                          child: Center(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              isExpanded: true,
                                                                              underline: Container(),
                                                                              items: cont.rh0taskStatusList.map((String value) {
                                                                                return DropdownMenuItem<String>(
                                                                                  value: value,
                                                                                  child: Text(value),
                                                                                );
