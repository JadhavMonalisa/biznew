...
class _TimesheetFormState extends State<TimesheetForm> {
          ...
          child: Scaffold(
              ...
              appBar: AppBar(
                ...
                title: buildTextMediumWidget(
                    "Timesheet", whiteColor, context, 16,
                                          ...
                                          content: Column(
                                            ...
                                            children: <Widget>[
                                              ...
                                              cont.validateInTime == true
                                                  ? ErrorText(
                                                      errorMessage:
                                                          "Please select valid in time (24 format)",
                                                    )
                                                  : const Opacity(opacity: 0.0),
                                              ...
                                              cont.validateOutTime == true
                                                  ? ErrorText(
                                                      errorMessage:
                                                          "Please select valid out time (24 format)",
                                                    )
                                                  : const Opacity(opacity: 0.0),
                                              ...
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  ...
                                                  border: Border.all(
                                                      color:
                                                          cont.validateTotalTime
                                                              ? errorColor
                                                              : grey),
                                                ),
                                                child: TextFormField(
                                                  controller:
                                                      cont.timesheetTotalTime,
                                                  keyboardType:
                                                      TextInputType.text,
                                                  textAlign: TextAlign.left,
                                                  textAlignVertical:
                                                        ...
                                                        Container(
                                                            ...
                                                            child: Center(
                                                              ...
                                                              child:
                                                                ...
                                                                items: cont
                                                                    ...
                                                                    : cont
                                                                        ...
                                                                        return DropdownMenuItem<
                                                                          ...
                                                                          onTap:
                                                                              () {
                                                                            cont.updateSelectedServiceId(value.serviceId!,
                                                                                value.id!);
                                                                          },
                                                                        );
                                                                      }).toList(),
                                                                onChanged:
                                                                    (val) {
                                                                  cont.checkServiceValidation(
                                                                      val!);
                                                                },
                                                              ),
                                                            ))),
                                                        cont.validateServiceName ==
                                                                true
                                                            ? ErrorText(
                                                                errorMessage:
                                                                    ...
                                                                    : ListView
                                                                        .builder(
                                                                            ...
                                                                            itemBuilder: (context,
                                                                              ...
                                                                              return cont.selectedTaskStatusList[index] == "0"
                                                                                  ? const Opacity(opacity: 0.0)
                                                                                  : Padding(
                                                                                      padding: const EdgeInsets.only(top: 5.0),
                                                                                      child: cont.selectedTaskStatusList.isEmpty
                                                                                          ? const Text("")
                                                                                          : Card(
                                                                                              elevation: 1.0,
                                                                                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(7.0), side: const BorderSide(color: grey)),
                                                                                              child: Column(
                                                                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                                                                children: [
                                                                                                  Padding(padding: const EdgeInsets.all(10.0), child: buildTextRegularWidget("${cont.selectedClient} - ${cont.selectedService}", blackColor, context, 14.0, align: TextAlign.left)),
                                                                                                  Padding(
                                                                                                  ...
                                                                                                  Padding(padding: const EdgeInsets.only(left: 10.0), child: buildTimeSheetTitle(context, "Time Spent")),
                                                                                                  Padding(
                                                                                                    padding: const EdgeInsets.only(left: 10.0, right: 10.0),
                                                                                                    child: GestureDetector(
                                                                                                      onTap: () {
                                                                                                  ...
                                                                                                  Padding(padding: const EdgeInsets.only(left: 10.0), child: buildTimeSheetTitle(context, "Status")),
                                                                                                  Padding(
                                                                                                      padding: const EdgeInsets.all(10.0),
                                                                                                      child: Container(
                                                                                                          height: 40.0,
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onChanged:
                                                                      ...
                                                                      if (value
                                                                          ...
                                                                          .isNotEmpty) {
                                                                        cont.validateTimeSpentStepper2 =
                                                                            false;
                                                                        if (value.length >=
                                                                                2 &&
                                                                            !value.contains(":")) {
                                              ...
                                              Container(
                                                  ...
                                                  child: Center(
                                                    ...
                                                    child:
                                                        DropdownButton<String>(
                                                      hint: buildTextRegularWidget(
                                                          cont.selectedOfficeRelatedStatus ==
                                                                  ""
                                                              ? "Type of work"
                                                              : cont
                                                              ...
                                                              return DropdownMenuItem<
                                                                ...
                                                                child: Text(
                                                                    value
                                                                        .name!),
                                                                onTap: () {
                                                                  cont.updateOfficeRelatedStatusId(
                                                                      value
                                                                          .id!);
                                                                },
                                                              );
                                                      ...
                                                      onChanged: (val) {
                                                        cont.checkOfficeRelatedStatusValidation(
                                                            val!, context);
                                                      },
                                                    ),
                                                  ))),
  ...
  openDialog(BuildContext context, TimesheetFormController cont, String val) {
    cont.selectedStatus = val;
    cont.validateStatusName = false;
                            ...
                            body: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  buildTextBoldWidget(
                                      "Remark", blackColor, context, 16.0),
                                  const SizedBox(
                                    height: 20.0,
                                  ),
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      borderRadius: const BorderRadius.all(
                                          Radius.circular(5)),
                                      border: Border.all(
                                          color: cont.validateRemarkStepper2
                                              ? errorColor
                                              : grey),
                                    ),
                                    child: TextFormField(
  ...
  openPopupForStatus(
      BuildContext context, TimesheetFormController cont, int taskIndex) {
    return showGeneralDialog(
      barrierLabel: "Label",
      barrierDismissible: true,
      barrierColor: Colors.black.withOpacity(0.5),
                ...
                child: Container(
                    ...
                    child: Scaffold(
                        ...
                        body: Padding(
                          ...
                          child: Column(
                            children: [
                              buildTextBoldWidget("Please select status",
                              ...
                              ListView.builder(
                                  shrinkWrap: true,
                                  itemCount:
                                      cont.allottedStartedStatusList.length,
                                  itemBuilder: (context, index) {
                                    return Padding(
                                      padding: const EdgeInsets.all(10.0),
                                      child: GestureDetector(
                                        onTap: () {
                                          cont.selectStepper2Status(
                                              context,
                                              cont.allottedStartedStatusList[
                                                  index],
                                              taskIndex);
                                          Navigator.pop(context);
                                        },
