          ...
          child: Scaffold(
              ...
              appBar: AppBar(
                ...
                title: buildTextMediumWidget(
                    "Leave Form", whiteColor, context, 16,
                                ...
                                child: Padding(
                                  ...
                                  child: ListView(
                                    children: [
                                      ...
                                      Container(
                                          ...
                                          child: Center(
                                            ...
                                            child: DropdownButton(
                                              ...
                                              isExpanded: true,
                                              underline: Container(),
                                              items: cont.leaveTypeList.isEmpty
                                                  ? cont.noDataList
                                                      .map((value) {
                                                  ...
                                                  : cont.leaveTypeList.map(
                                                      ...
                                                      return DropdownMenuItem<
                                                        ...
                                                        child: Text(leaveType
                                                            .leaveType!),
                                                        onTap: () {
                                                          cont.updateSelectedLeaveTypeId(
                                                              leaveType.id!,
                                                              leaveType
                                                                  .leaveType!);
                                                        },
                                              ...
                                              child: SizedBox(
                                                ...
                                                child: Column(
                                                  children: [
                                                    ...
                                                    buildTextRegularWidget(
                                                        "${cont.days} days "
                                                        "${cont.month == 0 ? "" : cont.month}"
                                                        " ${cont.month == 0 ? "" : "month"}"
                                                        "${cont.year == 0 ? "" : cont.year}"
                                                        " ${cont.year == 0 ? "" : "year"}",
                                                        blackColor,
                                                        context,
                                                        15.0),
                                      ...
                                      cont.selectedStartDateToShow ==
                                              cont.selectedEndDateToShow
                                          ? buildTextRegularWidget("Leave For ",
                                              blackColor, context, 15.0)
                                          : const Opacity(opacity: 0.0),
                                      cont.selectedStartDateToShow ==
                                              cont.selectedEndDateToShow
                                      ...
                                      cont.selectedLeaveType == "Exam Leave"
                                          ? Container(
                                              ...
                                              child: TextFormField(
                                                ...
                                                onChanged: (text) {
                                                  cont.checkNoOfThisAttemptValidation(
                                                      context);
                                                },
                                              ),
                                            )
                                                    ...
                                                    children: [
                                                      Radio(
                                                        activeColor:
                                                            Colors.green,
                                                        value:
                                                            cont.leaveForExamList[
                                                                index],
                                                        groupValue: cont
                                                            .selectedLeaveForExam,
                                                        visualDensity:
                                                            const VisualDensity(
                                                                horizontal:
                                                                    -4.0),
                                                        //selected: cont.leaveForExamList[index] == cont.selectedLeaveForExamIndex,
                                                        onChanged: (dynamic v) {
                                                          cont.changeSelectedIndexForExam(
                                                              v,
                                                              cont.leaveForExamList[
                                                                  index]);
                                                        },
                      ...
                      child: Padding(
                        ...
                        child: GestureDetector(
                          ...
                          child: buildButtonWidget(
                              context, screenFor == "add" ? "Submit" : "Update",
