                          ...
                          child: Center(
                              child: Padding(
                                ...
                                child: DropdownButton(
                                  hint: buildTextRegularWidget(cont.selectedLeaveStatus=="None"?"Select leave status":cont.selectedLeaveStatus, blackColor, context, 15.0),
                                  isExpanded: true,
                                  underline: Container(),
                                  items:
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (context,index){
                          return Padding(
                            ...
                            child: buildNewLeaveList(cont.leaveList[index],cont),);
                        })
                  ],
                ),
              ),
              ...
              children: [
                Flexible(
                  child: RichText(
                    text: TextSpan(
                      ...
                      style: const TextStyle(fontWeight: FontWeight.normal,color: blackColor,fontSize: 15.0),
                      children: <TextSpan>[
                        // TextSpan(
                        //     text: "${item.totalDays!} day ",
                        //     style: const TextStyle(fontWeight: FontWeight.bold,color: blackColor,fontSize: 15.0)),
                        TextSpan(
                            text: "of ${item.leaveType!} from ${item.startDateToShow!} to ${item.endDateToShow!} - ",
                            style: const TextStyle(fontWeight: FontWeight.normal,color: blackColor,fontSize: 15.0)),
                        TextSpan(
                            text: item.leaveStatus!,
                            style: TextStyle(fontWeight: FontWeight.bold,
                                color: item.leaveStatus == "Pending" || item.leaveStatus == "Pending for approval" ? Colors.orange :
                                item.leaveStatus == "Rejected" || item.leaveStatus == "Deleted" ? Colors.red :
                                item.leaveStatus == "Approved" ? Colors.green : faintGrey,
                                fontSize: 15.0)),
                      ],
                ...
                Container(
                  ...
                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(5.0),
                      color: buttonColor),
                  child: Center(child:buildTextRegularWidget("${item.totalDays!} day",
    ...
    return Card(
      ...
      child: ExpansionTile(
        ...
        children: <Widget>[
          Table(
            children: [
              buildTableTitle(context,title1: "Total Days",title2: "Total Leaves",title3: "Updated On",fontSize: 14.0),
              buildContentSubTitle(context,contentTitle1: item.totalDays!,contentTitle2: item.dayLeave!,
               contentTitle3: item.modifiedOn!,fontSize: 14.0,padding1: 30.0,padding2: 40.0),
              const TableRow(children: [SizedBox(height: 15.0,),SizedBox(height: 15.0,),SizedBox(height: 15.0,),],),
            ],
          ),
