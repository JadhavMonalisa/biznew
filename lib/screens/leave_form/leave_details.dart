      ...
      return WillPopScope(
          ...
          child:Scaffold(
              appBar: AppBar(
                ...
                title: buildTextMediumWidget("Leave Details", whiteColor,context, 16,align: TextAlign.center),
                leading: GestureDetector(
                  onTap: (){cont.onBackPressToLeaveList();},
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  buildRichTextWidget("Leave Status - ", item.leaveStatus!,title1Weight: FontWeight.normal,title2Weight: FontWeight.bold),
                                  const SizedBox(height: 10.0,),
                                  buildTextRegularWidget("Updated On", blackColor, context, 14.0),
                                  buildTextBoldWidget(item.modifiedOn!, blackColor, context, 14.0),
                                  const SizedBox(height: 10.0,),
                                  buildTextRegularWidget("Leave type", blackColor, context, 14.0),
                                  buildTextBoldWidget(item.leaveTypeName!, blackColor, context, 14.0),
                                  const SizedBox(height: 10.0,),
                                  ...
                                  Table(
                                    children: [
                                      buildTableTitle(context,title1: "Start Date",title2: "End Date",title3: "Days",fontSize: 14.0),
                                      buildContentSubTitle(context,contentTitle1: item.startDateToShow!,contentTitle2: item.endDateToShow!,contentTitle3: item.totalDays!,fontSize: 14.0),
