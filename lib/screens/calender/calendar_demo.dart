    ...
    return GetBuilder<CalenderViewController>(builder: (cont)
    {
      return
       ...
       child: Scaffold(
        ...
        body: cont.isLoading ? buildCircularIndicator():
        Column(
          children: [
            TableCalendar<Event>(
              firstDay: kFirstDay,
              ...
              calendarBuilders: CalendarBuilders(
                markerBuilder: (BuildContext context, date, events) {
                  String formattedDate = "${date.year}-"
                      ...
                      "${date.day
                      .toString()
                      .length == 1 ? "0${date.day.toString()}" : date
                      .day.toString()}";

                  if (cont.calenderDataList.isEmpty) return const SizedBox();
                  return
                    ListView.builder(
                      shrinkWrap: true,
                      ...
                      itemBuilder: (context, index) {
                        return
                          cont.calenderDataList[index].start == formattedDate ?
                          Container(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: Color(cont.calenderDataList[index].newColor!)
                            ),
                          ),
                        )
                ...
                defaultBuilder: (context, day, focusedDay) {
                  ...
                  String selectedFormattedDate = "${day.year}-"
                      ...
                      .toString()
                      .length == 1
                      ? "0${day.month.toString()}"
                      : day.month.toString()}-"
                      "${day.day
                      .toString()
                      .length == 1 ? "0${day.day.toString()}" : day
                      .day.toString()}";
                  //

                  return
                    selectedFormattedDate == selectedDate ?
                    Container(
              ...
              setState(() {
                ...
                selectedDate = "${selection1.year}-"
                    ...
                    .toString()
                    .length == 1
                    ? "0${selection1.month.toString()}"
                    : selection1.month.toString()}-"
                    "${selection1.day
                    .toString()
                    .length == 1 ? "0${selection1.day.toString()}" : selection1
                    .day.toString()}";
                print("selectedDate");
                print(selectedDate);
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  String focusDate = "${_focusedDay.year}-"
                      ...
                      .toString()
                      .length == 1
                      ? "0${_focusedDay.month.toString()}"
                      : _focusedDay.month.toString()}-"
                      "${_focusedDay.day
                      .toString()
                      .length == 1 ? "0${_focusedDay.day.toString()}" : _focusedDay
                      .day.toString()}";

                  String dateToCompare =
                  selectedDate=="" || selectedDate.isEmpty ? focusDate : selectedDate;

                  return
                    cont.calenderDataList[index].start == dateToCompare ?
                    Container(
                      ...
                      child: ListTile(
                        onTap: () {
                          cont.navigateToCalenderDetailScreen(cont.calenderDataList[index].constraint!,cont.calenderDataList[index].start!);
                        },
                        //title: Text('${value[index]}'),
                        title: buildTextBoldWidget(cont.calenderDataList[index].start!, whiteColor, context, 14.0),
                        subtitle: buildTextBoldWidget(cont.calenderDataList[index].title!, whiteColor, context, 14.0,align: TextAlign.left),
                      ),
                    )
                        : const Opacity(opacity: 0.0,);
                },
