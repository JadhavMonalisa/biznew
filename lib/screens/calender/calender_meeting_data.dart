      ...
      return WillPopScope(
          ...
          child: Scaffold(
              ...
              appBar: AppBar(
                ...
                title: buildTextMediumWidget(cont.typeToSendApi == "OwnCount" ? "Own Due Data":
                                             cont.typeToSendApi == "TeamCount" ? "Team Due Data":
                                             cont.typeToSendApi == "Holiday" ? "Holiday Due Data":"Appointment Due Data",
                    ...
                    child: ListView(
                      ...
                      children: [
                        Padding(
                          ...
                          child: buildTextBoldWidget("Statutory Due Date for ${cont.dateOnDueDataScreen.day}/${cont.dateOnDueDataScreen.month}/${cont.dateOnDueDataScreen.year}",
                              primaryColor, context, 14.0),
                        ),
                        ListView.builder(
                            shrinkWrap: true,
                                ...
                                child: Card(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                          ...
                                          Flexible(child: Container(
                                              ...
                                              child: Align(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: buildTextBoldWidget(item.client!, blackColor, context, 14.0,align: TextAlign.left),
                                                  )
                                              )
                                          ),)
                                        ],
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.only(left: 10.0),
                                        child: buildTextRegularWidget("${item.service} triggered on ${item.triggerDate} and ending on ${item.targetDate}",
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            buildTextBoldWidget(item.status!, item.status=="Inprocess" ? Colors.green : Colors.red, context, 14.0),
                                            const Spacer(),
                                            buildTextBoldWidget(item.priority!,
                                                item.priority=="High" ? errorColor:
                                                item.priority=="Medium"? Colors.orange : approveColor,
                                                context, 14.0),
                                          ],
                                        ),
                                      ),
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            buildTextRegularWidget("${item.completion}  |  ${item.total} %", blackColor, context, 14.0),
                                          ],
                                        )
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.only(left: 10.0,right: 10.0,top: 10.0,bottom: 20.0),
                                        child: buildRichTextWidget("Assigned to - ", "${item.name}"),
                                      )
                                    ],
                                  ),
                                ),
